			...
			<div class="container">
				<div class="top-menu">
					<ul>
						...
						<li><a href="searchlist_log.php">Cuisines</a></li>|
						<div class="clearfix"></div>
					</ul>
				</div>
				...
				<div class="Popular-Restaurants-grid wow fadeInRight" data-wow-delay="0.4s">
					...
					<div class="col-md-2 restaurent-title">
						<div class="logo-title">
							<h4><a href="rest_Detail.php?restid=<?php echo $id; ?>"> <?php echo $row["rest_Name"];  ?> </a></h4>
                        </div>
						<div class="company_ad">
                            ...
                            <span><a href="review.php?restname=<?php echo $row["rest_Name"];  ?>&restid=<?php echo $row["rest_ID"];?>"> Write Review </a></span><br>
                            <span style="color: crimson"> <a href="sendInvite.php?restid=<?php echo $row["rest_ID"]; ?>">Send Invitation</a></span>
