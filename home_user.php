...
if($_SESSION['SESS_ROLE'] !="admin") { //if not yet logged in
	...
	<div class="header">
		<div class="container">
			<div class="top-header">
				<div class="logo">
					<img src="images/restlogo.png" class="img-responsive" alt="" /></a>
				</div>
		    ...
		    <div class="container">
				<div class="banner-info">
					...
					<div class="form-list wow fadeInRight" data-wow-delay="0.5s">
						<form name="rest_find" action="searchlist_admin.php" method="post">
						  <ul class="navmain">
