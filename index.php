			...
			<div class="container">
				<div class="top-menu">
					<ul>
						...
						<li><a href="popular.php">Popular Restaurants</a></li>|
		    ...
		    <div class="container">
				<div class="banner-info">
					...
					<div class="form-list wow fadeInRight" data-wow-delay="0.5s">
						<form name="rest_find" action="searchlist.php" method="post">
						  <ul class="navmain">
					...
					<div class="top-restaurent-grids">
						<div class="top-restaurent-logos">
						  <div class="res-img-1 wow bounceIn" data-wow-delay="0.4s">
                            <a href="rest_Detail.php?restname=PizzaHut" > <img  src="images/restaurent-logo1.jpg" class="img-responsive" alt="" /></a>
							</div>
							<div class="res-img-2 wow bounceIn" data-wow-delay="0.4s">
						      <a href="rest_Detail.php?restname=Subway"><img src="images/restaurent-logo2.jpg" class="img-responsive" alt="" /></a>
							</div>
							<div class="res-img-1 wow bounceIn" data-wow-delay="0.4s">
						     <a href="rest_Detail.php?restname=Starbucks"> <img src="images/starbucks.jpeg" class="img-responsive" alt="" /></a>
							</div>
						  <div class="res-img-2 wow bounceIn" data-wow-delay="0.4s">
						     <a href="rest_Detail.php?restname=Papa"> <img src="images/restaurent-logo4.jpg" class="img-responsive" alt="" /></a>
							</div>
							<div class="res-img-1 nth-grid1 wow bounceIn" data-wow-delay="0.4s">
						      <a href="rest_Detail.php?restname=Dominos"><img src="images/restaurent-logo5.jpg" class="img-responsive" alt="" /></a>
							</div>
						  <div class="res-img-2 nth-grid1 wow bounceIn" data-wow-delay="0.4s">
						      <a href="rest_Detail.php?restname=KFC"><img src="images/restaurent-logo6.jpg" class="img-responsive" alt="" /></a>
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
