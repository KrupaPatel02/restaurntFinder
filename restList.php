...
// $query = " Select * from restaurant Where rest_Street LIKE '%".$_POST['location']."%' || rest_Name LIKE '%".$_POST['restaurant']."%' || cuisine='%".$_POST['cuisine']."%'";
    ...
    $query = "select * from restaurant where user_id='$id'";
		...
		if($n > 0) {
             while ($row = $sql->fetch_assoc())      {  
               ...
               $_SESSION['SESSION_REST_PHONE'] = $row["rest_Phone"];
                ...
                $_SESSION['SESSION_REST_ID'] = $row["rest_ID"];
				...
				<div class="Popular-Restaurants-grid wow fadeInRight" data-wow-delay="0.4s">
					...
					<div class="col-md-2 restaurent-title">
						<div class="logo-title">
							<h4><a href="rest_Detail_Admin.php?restid=<?php echo $restid; ?>"> <?php echo $row["rest_Name"];  ?> </a></h4>
						</div>
						<div class="company_ad">
                            ...
                            <div><a href="updateRestDetails.php?restid=<?php echo $restid; ?>"><input type="button" value="Update"/></a> 
                            </div>
					</div>
					<div class="clearfix"></div>
				</div>
