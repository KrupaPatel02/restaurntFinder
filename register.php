...
<body>
	...
	<div class="main">
	   <div class="container">
		  <div class="register">
		  	  <form name="registerForm" action="register_exec.php" method="post"> 
					...
					<h3>PERSONAL INFORMATION</h3>
				     ...
				     <div class="register-bottom-grid">
                          ...
                          <div class="wow fadeInLeft" data-wow-delay="0.4s">
                                ...
                                <input type="radio" name="role" value="user">Regular User
                            <input type="radio" name="role" value="admin">Restaurant Owner
							 </div>
					 </div>
				<div class="clearfix"> </div>
				<div class="register-but">
					   <input type="submit" style="background-color:darkorange" name="submit">
					   <div class="clearfix"> </div>
				   </form>
